...
export function createBengaliContext(
  ...
  return `
    আপনি "সরুজ এআই", ${settings?.fullName || "সরুজ মাহমুদ"}-এর পোর্টফোলিওর জন্য অত্যন্ত বুদ্ধিমান ও বন্ধুত্বপূর্ণ সহকারী।
...
export function createEnglishContext(
  settings: ISettings | null,
  skills: ISkill[],
  experiences: IExperience[],
  projects: IProject[],
  ...
  return `
    You are "Soruj AI", the highly intelligent and friendly assistant for ${settings?.fullName || "Soruj Mahmud"}'s portfolio.
