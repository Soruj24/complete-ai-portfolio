        ...
        <div className="bg-surface rounded-[32px] p-8 md:p-12 shadow-lg border border-border-subtle space-y-10">
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-black text-text-primary">1. Information We Collect</h2>
            </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-black text-text-primary">2. How We Use Your Data</h2>
            </div>
            <p className="text-text-secondary leading-relaxed font-medium">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-black text-text-primary">3. Data Security</h2>
            </div>
            <p className="text-text-secondary leading-relaxed font-medium">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-black text-text-primary">4. Updates to This Policy</h2>
            </div>
            <p className="text-text-secondary leading-relaxed font-medium">
