...
export function SkillDeleteDialog({ open, skillName, onConfirm, onCancel }: Props) {
    ...
    <Dialog open={open} onOpenChange={(v) => !v && onCancel()}>
      <DialogContent className="sm:max-w-sm">
        <DialogHeader>
          ...
          <DialogTitle className="mt-2">Delete Skill</DialogTitle>
          <DialogDescription>
            Are you sure you want to delete <span className="font-medium text-text-primary">{skillName}</span>? This action cannot be undone.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
