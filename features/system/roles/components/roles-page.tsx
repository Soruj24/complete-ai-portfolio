...
import { Search, Shield, Plus, Edit2, Trash2 } from "lucide-react";
import type { Role } from "../types";

const MOCK: Role[] = [
  { id: "role-1", name: "Super Admin", description: "Full system access with all permissions", users: 2, permissions: 47, color: "#ef4444", createdAt: "2025-01-01" },
  { id: "role-2", name: "Admin", description: "Administrative access to all features", users: 5, permissions: 42, color: "#f97316", createdAt: "2025-01-01" },
  { id: "role-3", name: "Editor", description: "Can create and edit content", users: 12, permissions: 28, color: "#3b82f6", createdAt: "2025-01-15" },
  { id: "role-4", name: "Author", description: "Can create content but needs approval", users: 8, permissions: 18, color: "#8b5cf6", createdAt: "2025-02-01" },
  { id: "role-5", name: "Moderator", description: "Can moderate comments and reviews", users: 4, permissions: 15, color: "#06b6d4", createdAt: "2025-02-15" },
  { id: "role-6", name: "Viewer", description: "Read-only access to content", users: 18, permissions: 8, color: "#6b7280", createdAt: "2025-03-01" },
];
